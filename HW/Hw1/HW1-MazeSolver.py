...
from MazeBuilder import BuildMaze
import matplotlib.pyplot as plt
import numpy as np
import os, sys, time, datetime, json, random

# Constants for the learning model
visited_mark = 0.8
player_mark = 0.5
LEFT = 0
UP = 1
RIGHT =2
DOWN = 3
# Dictionary of the possbile actions that can be performed
actions = {
    LEFT: 'Left',
    RIGHT: 'Right',
    UP: 'up',
...
class QMaze(object):
    ...
    def __init__(self, maze, player=(0,0)):
        ...
        if not player in self.free_cells:
...
def show(qmaze):
    ...
    canvas[player_row, player_col] = 0.3   # player cell
    canvas[nrows-1, ncols-1] = 0.9 # final cell
...
# Print 2D array of maze with barriers
# print(summaze.matrix)
# qmaze = QMaze(summaze.matrix)
...
# canvas, reward, game_over = qmaze.act(DOWN)  # move down
# print("reward=", reward)
# canvas, reward, game_over = qmaze.act(RIGHT)  # move right
# print("reward=", reward)
# canvas, reward, game_over = qmaze.act(RIGHT)  # move right
# print("reward=", reward)
# canvas, reward, game_over = qmaze.act(RIGHT)  # move right
